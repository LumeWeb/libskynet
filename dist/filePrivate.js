...
exports.getPaddedFileSize = exports.encryptFileSmall = exports.decryptFileSmall = void 0;
const encoding_js_1 = require("./encoding.js");
const encrypt_js_1 = require("./encrypt.js");
const err_js_1 = require("./err.js");
const parse_js_1 = require("./parse.js");
const sha512_js_1 = require("./sha512.js");
const stringifyJSON_js_1 = require("./stringifyJSON.js");
...
// all at once.
function decryptFileSmall(seed, inode, fullDataOrig) {
    ...
    const [metadataBI, errDU641] = (0, encoding_js_1.decodeU64)(fullData.slice(24, 32));
    if (errDU641 !== null) {
        return [{}, new Uint8Array(0), (0, err_js_1.addContextToErr)(errDU641, "unable to decode metadata length")];
    }
    const metadataLen = Number(metadataBI);
    const [fileDataBI, errDU642] = (0, encoding_js_1.decodeU64)(fullData.slice(32, 40));
    if (errDU642 !== null) {
        return [{}, new Uint8Array(0), (0, err_js_1.addContextToErr)(errDU642, "unable to decode file data length")];
    }
    ...
    const [metadata, errPJ] = (0, parse_js_1.parseJSON)(metadataStr);
    if (errPJ !== null) {
        return [{}, new Uint8Array(0), (0, err_js_1.addContextToErr)(errPJ, "unable to parse metadata")];
    }
...
exports.decryptFileSmall = decryptFileSmall;
...
function encryptFileSmall(seed, inode, revision, metadata, fileData, minFullSize) {
    // Get a json encoding of the metadata. We need to know the size of the
    // metadata before allocating the full data for the file.
    const [metadataStr, errJS] = (0, stringifyJSON_js_1.jsonStringify)(metadata);
    if (errJS !== null) {
        return [new Uint8Array(0), (0, err_js_1.addContextToErr)(errJS, "unable to stringify the metadata")];
    }
    ...
    // state.
    const [encodedRevision, errEU643] = (0, encoding_js_1.encodeU64)(revision);
    if (errEU643 !== null) {
        return [new Uint8Array(), (0, err_js_1.addContextToErr)(errEU643, "unable to encode revision number")];
    }
    const [encodedMetadataSize, errEU642] = (0, encoding_js_1.encodeU64)(BigInt(metadataBytes.length));
    if (errEU642 !== null) {
        return [new Uint8Array(), (0, err_js_1.addContextToErr)(errEU642, "unable to encode metadata size")];
    }
    const [encodedFileSize, errEU641] = (0, encoding_js_1.encodeU64)(BigInt(fileData.length));
    if (errEU641 !== null) {
        return [new Uint8Array(), (0, err_js_1.addContextToErr)(errEU641, "unable to encode file data size")];
    }
    ...
    const fullHash = (0, sha512_js_1.sha512)(fullData.slice(16, fullData.length));
...
exports.encryptFileSmall = encryptFileSmall;
...
function getPaddedFileSize(originalSize) {
...
exports.getPaddedFileSize = getPaddedFileSize;
