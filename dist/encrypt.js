...
// attacks.
function otpEncrypt(key, data, skip = 0) {
    ...
    for (let i = skip; i < data.length; i += sha512_js_1.SHA512_HASH_SIZE) {
        ...
        const [iBytes] = (0, encoding_js_1.encodeU64)(BigInt(i));
        preimageHolder.set(iBytes, key.length);
        const keyData = (0, sha512_js_1.sha512)(preimageHolder);
