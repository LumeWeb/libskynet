...
const skylinkBitfield_js_1 = require("../src/skylinkBitfield.js");
test.each([
    ...
    const [bitfield, errSVB] = (0, skylinkBitfield_js_1.skylinkV1Bitfield)(dataSize);
    expect(errSVB).toBe(null);
    skylink.set(bitfield, 0);
    const [version, offset, fetchSize, errPSB] = (0, skylinkBitfield_js_1.parseSkylinkBitfield)(skylink);
