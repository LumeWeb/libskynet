...
exports.validateObjPropTypes = void 0;
...
function validateObjPropTypes(obj, checks) {
    for (let i = 0; i < checks.length; i++) {
        ...
        for (let j = 0; j < arrayCases.length; j++) {
            ...
            if (err !== null) {
                return (0, err_js_1.addContextToErr)(err, `check failed for array property '${property}'`);
            }
...
exports.validateObjPropTypes = validateObjPropTypes;
